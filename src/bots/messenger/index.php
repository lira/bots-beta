<?php
	...
	*/
	define('BOT_TOKEN', "EAAERPIZCsMMwBANZCiFMYCwf4JiaPSFdDmzUSdTqv8hHLCd6Qo4wti1AbmbVODdI0fdNGr9emjfM5eNXmotj3d1m6EdwZBXV2EhUBimig2CVZCF8xPyBaOaOLFuSgEYx2NfbOKxqcZBSZC2ue0LzPuNwbQcAMj2Kk9E0Cbp4tsqgZDZD");
		...
		if (isset($text)) {
			if(preg_match('[data|hora|agora]', strtolower($text))) {
				...
				if($result != '') {
					...
					sendMessage(array('recipient' => array('id' => $sender), 'message' => array('text' => 'São ' . date('d-m-Y H:i:s'))));
				}
			} else {
